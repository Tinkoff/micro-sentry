...
import {getFetchMethod, getFetchUrl, supportsNativeFetch} from '../utils/fetch-utils';
...
export class BreadcrumbPlugin implements MicroSentryPlugin {
    ...
    private initDOM() {
        const clickEventHandler = (event: Event) => this.prepareDomEvent('click', event);
        ...
        this.subscriptions.push(() => {
            ...
            window.document.removeEventListener('keypress', keypressEventHandler, false);
        });
    }
